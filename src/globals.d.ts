...
declare global {
    ...
    export var NavinecordNative: typeof import("./NavinecordNative").default;
    export var Navinecord: typeof import("./Navinecord");
    export var NavinecordStyles: Map<string, Style>;
