...
import * as t from "@Navinecord/discord-types";
...
export const Forms = {
    ...
    /** @deprecated use Heading from Navinecord */
    FormTitle: Heading,
    /** @deprecated use Paragraph from Navinecord */
    FormText: Paragraph,
...
/** @deprecated use Paragraph, Span, or BaseText from Navinecord */
export const Text = TextCompat;
/** @deprecated use Button from Navinecord */
export const Button = ButtonCompat;
/** @deprecated Use FormSwitch from Navinecord */
...
/** @deprecated import from @Navinecord/components */
