...
export default definePlugin({
    ...
    patches: [
        {
            ...
            replacement: {
                ...
                // react.jsx(WrapperComponent, { NavinecordOriginal: AccountPanel, ...
                replace: "$self.PanelWrapper,{NavinecordOriginal:$1,"
            }
        },
        {
            find: ".PLAYER_DEVICES",
    ...
    PanelWrapper({ NavinecordOriginal, ...props }) {
        return (
            <>
                <ErrorBoundary
                    fallback={() => (
