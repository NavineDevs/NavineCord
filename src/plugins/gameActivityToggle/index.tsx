...
import NavinecordToolboxPlugin from "@plugins/NavinecordToolbox";
...
const settings = definePluginSettings({
    ...
    location: {
        ...
        options: [
            ...
            { label: "Navinecord Toolbox", value: "TOOLBOX" }
        ],
        get hidden() {
            return !isPluginEnabled(NavinecordToolboxPlugin.name);
        }
    }
});
...
function GameActivityToggleButton(props: { nameplate?: any; }) {
    ...
    if (location !== "PANEL" && isPluginEnabled(NavinecordToolboxPlugin.name)) return null;
