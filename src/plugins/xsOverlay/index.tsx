...
import type { Channel, Embed, GuildMember, MessageAttachment, User } from "@Navinecord/discord-types";
...
async function start() {
    ...
    socket = new WebSocket(`ws://127.0.0.1:${settings.store.webSocketPort ?? 42070}/?client=Navinecord`);
...
const Native = NavinecordNative.pluginHelpers.XSOverlay as PluginNative<typeof import("./native")>;
