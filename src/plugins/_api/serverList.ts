    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: "[$1].concat(Navinecord.Api.ServerList.renderAll(Navinecord.Api.ServerList.ServerListRenderPosition.Above))"
            }
        },
        {
            find: ".setGuildsTree(",
            replacement: {
                ...
                replace: "Navinecord.Api.ServerList.renderAll(Navinecord.Api.ServerList.ServerListRenderPosition.In).concat($&)"
            }
        }
    ]
});
