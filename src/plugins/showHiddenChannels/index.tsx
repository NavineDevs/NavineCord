...
import type { Channel, Role } from "@Navinecord/discord-types";
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: (m, channel, permCheck) => `${m}!Navinecord.Webpack.Common.PermissionStore.can(${CONNECT}n,${channel})?${permCheck}CONNECT):`
                },
                {
