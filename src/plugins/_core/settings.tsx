...
import { BackupAndRestoreTab, CloudTab, PatchHelperTab, PluginsTab, ThemesTab, UpdaterTab, NavinecordTab } from "@components/settings/tabs";
...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Navinecord settings section",
        options: [
...
export default definePlugin({
    ...
    getSettingsSectionMappings() {
        return [
            ["NavinecordSettings", "Navinecord_main_panel"],
            ["NavinecordPlugins", "Navinecord_plugins_panel"],
            ["NavinecordThemes", "Navinecord_themes_panel"],
            ["NavinecordUpdater", "Navinecord_updater_panel"],
            ["NavinecordCloud", "Navinecord_cloud_panel"],
            ["NavinecordBackupAndRestore", "Navinecord_backup_restore_panel"],
            ["NavinecordPatchHelper", "Navinecord_patch_helper_panel"]
        ];
    },
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        if (layout.some(s => s?.key === "Navinecord_section")) return layout;

        const { buildEntry } = this;

        const NavinecordEntries: SettingsLayoutNode[] = [
            buildEntry({
                key: "Navinecord_main",
                title: "Navinecord",
                panelTitle: "Navinecord Settings",
                Component: NavinecordTab,
                Icon: MainSettingsIcon
            }),
            buildEntry({
                key: "Navinecord_plugins",
                title: "Plugins",
                Component: PluginsTab,
                Icon: PluginsIcon
            }),
            buildEntry({
                key: "Navinecord_themes",
                title: "Themes",
                Component: ThemesTab,
                Icon: PaintbrushIcon
            }),
            !IS_UPDATER_DISABLED && UpdaterTab && buildEntry({
                key: "Navinecord_updater",
                title: "Updater",
                panelTitle: "Navinecord Updater",
                Component: UpdaterTab,
                Icon: UpdaterIcon
            }),
            buildEntry({
                key: "Navinecord_cloud",
                title: "Cloud",
                panelTitle: "Navinecord Cloud",
                Component: CloudTab,
                Icon: CloudIcon
            }),
            buildEntry({
                key: "Navinecord_backup_restore",
                title: "Backup & Restore",
                Component: BackupAndRestoreTab,
                Icon: BackupRestoreIcon
            }),
            IS_DEV && PatchHelperTab && buildEntry({
                key: "Navinecord_patch_helper",
                title: "Patch Helper",
            ...
            ...this.customSections.map((func, i) => {
                ...
                return buildEntry({
                    key: `Navinecord_deprecated_custom_${section}`,
                    title: label,
                    Component: element,
        ...
        const NavinecordSection: SettingsLayoutNode = {
            key: "Navinecord_section",
            type: LayoutTypes.SECTION,
            useTitle: () => "Navinecord Settings",
            buildLayout: () => NavinecordEntries
        };
        ...
        layout.splice(idx, 0, NavinecordSection);
    ...
    makeSettingsCategories(SectionTypes: SectionTypes) {
        return [
            ...
            {
                section: "NavinecordSettings",
                label: "Navinecord",
                element: NavinecordTab,
                className: "vc-settings"
            },
            {
                section: "NavinecordPlugins",
                label: "Plugins",
                element: PluginsTab,
                className: "vc-plugins"
            },
            {
                section: "NavinecordThemes",
                label: "Themes",
                element: ThemesTab,
                className: "vc-themes"
            },
            !IS_UPDATER_DISABLED && {
                section: "NavinecordUpdater",
                label: "Updater",
                element: UpdaterTab,
                className: "vc-updater"
            },
            {
                section: "NavinecordCloud",
                label: "Cloud",
                element: CloudTab,
                className: "vc-cloud"
            },
            {
                section: "NavinecordBackupAndRestore",
                label: "Backup & Restore",
                element: BackupAndRestoreTab,
                className: "vc-backup-restore"
            },
            IS_DEV && {
                section: "NavinecordPatchHelper",
                label: "Patch Helper",
    ...
    get electronVersion() {
        return NavinecordNative.native.getVersions().electron || window.legcord?.electron || null;
    },

    get chromiumVersion() {
        try {
            return NavinecordNative.native.getVersions().chrome
    ...
    getInfoRows() {
        ...
        const rows = [`Navinecord ${gitHash}${additionalInfo}`];
