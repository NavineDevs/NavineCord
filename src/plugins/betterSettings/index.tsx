...
import { buildPluginMenuEntries, buildThemeMenuEntries } from "@plugins/NavinecordToolbox/menu";
...
export default definePlugin({
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: "$&case 'NavinecordPlugins':return $self.buildPluginMenuEntries(true);$&case 'NavinecordThemes':return $self.buildThemeMenuEntries();"
                }
            ]
        },
    ],
    ...
    Layer(props: LayerProps) {
        try {
            [FocusLock.$$NavinecordGetWrappedComponent(), ComponentDispatch, Classes.layer].forEach(e => e.test);
        } catch {
