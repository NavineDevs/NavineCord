...
import { Channel, Message } from "@Navinecord/discord-types";
...
function NavinecordPopoverButtons(props: { Component: React.ComponentType<MessagePopoverButtonItem>, message: Message; }) {
...
export function _buildPopoverElements(
    ...
    return <NavinecordPopoverButtons Component={Component} message={message} />;
}
