...
import { FluxEvents } from "@Navinecord/discord-types";
...
export function addPatch(newPatch: Omit<Patch, "plugin">, pluginName: string, pluginPath = `Navinecord.Plugins.plugins[${JSON.stringify(pluginName)}]`) {
