...
export function shouldCloudSync(direction: "push" | "pull") {
    const localDirection = localStorage.Navinecord_cloudSyncDirection;
...
export async function putCloudSettings(manual?: boolean) {
    ...
    try {
        ...
        NavinecordNative.settings.set(PlainSettings);
        ...
        delete localStorage.Navinecord_settingsDirty;
    } catch (e: any) {
