...
function NavinecordChatBarButtons(props: ChatBarProps) {
...
export function _injectButtons(buttons: ReactNode[], props: ChatBarProps) {
    ...
    buttons.unshift(<NavinecordChatBarButtons key="Navinecord-chat-buttons" {...props} />);
}
...
addContextMenuPatch("textarea-context", (children, args) => {
    ...
    group.splice(idx, 0,
        <Menu.MenuItem id="vc-chat-buttons" key="Navinecord-chat-buttons" label="Navinecord Buttons">
            {buttons.map(([id]) => (
