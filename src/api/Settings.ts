...
const DefaultSettings: Settings = {
    ...
    cloud: {
        authenticated: false,
        url: "https://api.Navinecord.dev/",
        settingsSync: false,
        settingsSyncVersion: 0
    }
};

const settings = !IS_REPORTER ? NavinecordNative.settings.get() : {} as Settings;
...
if (!IS_REPORTER) {
    SettingsStore.addGlobalChangeListener((_, path) => {
        ...
        NavinecordNative.settings.set(SettingsStore.plain, path);
    });
}
