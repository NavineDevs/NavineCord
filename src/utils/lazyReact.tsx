...
export type LazyComponentWrapper<ComponentType> = ComponentType & { $$NavinecordGetWrappedComponent(): ComponentType; };
...
export function LazyComponent<T extends object = any>(factory: () => ComponentType<T>, attempts = 5): LazyComponentWrapper<ComponentType<T>> {
    ...
    LazyComponent.$$NavinecordGetWrappedComponent = get;
