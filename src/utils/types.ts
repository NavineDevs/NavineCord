...
import { Command, FluxEvents } from "@navinecord/discord-types";
...
export interface PluginDef {
    ...
    /**
     * Allows you to add custom actions to the Navinecord Toolbox.
     *
...
export const enum StartAt {
    /** Right away, as soon as Navinecord initialised */
    Init = "Init",
...
> {
    /** Shorthand for `Navinecord.Settings.plugins.PluginName`, but with typings */
    store: SettingsStore<Def> & PrivateSettings;
    /** Shorthand for `Navinecord.PlainSettings.plugins.PluginName`, but with typings */
