...
import { User } from "@Navinecord/discord-types";
...
function ContributorModal({ user }: { user: User; }) {
    ...
    const ContributedHyperLink = <Link href="https://Navinecord.dev/source">contributed</Link>;
    ...
    return (
        <>
            ...
            {plugins.length ? (
                ...
                <Forms.FormText>
                    This person has not made any plugins. They likely {ContributedHyperLink} to Navinecord in other ways!
                </Forms.FormText>
            )}
