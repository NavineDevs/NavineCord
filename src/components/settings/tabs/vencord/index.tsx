...
import { gitRemote } from "@shared/NavinecordUserAgent";
        ...
        <SettingsTab>
            {isDonor(user?.id)
                ...
                : (
                    <SpecialCard
                        ...
                        description="Please consider supporting the development of Navinecord by donating!"
            ...
            {isPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Navinecord you now have a cool new badge!"
            ...
            <section>
                ...
                <QuickActionCard>
                    ...
                    <QuickAction
                        Icon={PaintbrushIcon}
                        text="Edit QuickCSS"
                        action={() => NavinecordNative.quickCss.openEditor()}
                    />
                    {!IS_WEB && (
                        <>
                            <QuickAction
                            ...
                            <QuickAction
                                ...
                                action={() => NavinecordNative.settings.openFolder()}
                            />
                        </>
                    )}
                    <QuickAction
                        ...
                        action={() => NavinecordNative.native.openExternal("https://github.com/" + gitRemote)}
                    />
                </QuickActionCard>
            </section>
            ...
            <section className={Margins.top16}>
                ...
                <Forms.FormText className={Margins.bottom20} style={{ color: "var(--text-muted)" }}>
                    ...
                    <a onClick={() => openPluginModal(Navinecord.Plugins.plugins.Settings)}>
...
export default wrapTab(NavinecordSettings, "Navinecord Settings");
