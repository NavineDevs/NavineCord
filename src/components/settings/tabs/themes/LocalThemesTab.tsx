...
async function onFileUpload(e: SyntheticEvent<HTMLInputElement>) {
    ...
    const uploads = Array.from(files, file => {
        ...
        return new Promise<void>((resolve, reject) => {
            ...
            reader.onload = () => {
                NavinecordNative.themes.uploadTheme(name, reader.result as string)
                    .then(resolve)
                    .catch(reject);
            };
...
export function LocalThemesTab() {
    ...
    async function refreshLocalThemes() {
        const themes = await NavinecordNative.themes.getThemesList();
                        ...
                        {IS_WEB ?
                            (
                                ...
                                <QuickAction
                                    ...
                                    action={() => NavinecordNative.themes.openFolder()}
                                    Icon={FolderIcon}
                                />
                            )}
                        <QuickAction
                    ...
                    {userThemes?.map(theme => (
                        <ThemeCard
                            ...
                            onDelete={async () => {
                                ...
                                await NavinecordNative.themes.deleteTheme(theme.fileName);
                                refreshLocalThemes();
                            }}
                            theme={theme}
                        />
