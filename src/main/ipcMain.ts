...
const RENDERER_CSS_PATH = join(__dirname, IS_VESKTOP ? "NavinecordDesktopRenderer.css" : "renderer.css");
...
ipcMain.handle(IpcEvents.OPEN_MONACO_EDITOR, async () => {
    const title = "Navinecord QuickCSS Editor";
    ...
    const win = new BrowserWindow({
        ...
        darkTheme: true,
        webPreferences: {
            preload: join(__dirname, IS_DISCORD_DESKTOP ? "preload.js" : "NavinecordDesktopPreload.js"),
