...
console.log("[Navinecord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Navinecord");
    ...
    console.log("[Navinecord] Running in vanilla mode. Not loading Navinecord");
}

console.log("[Navinecord] Loading original Discord app.asar");
