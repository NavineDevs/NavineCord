...
![](https://img.shields.io/github/package-json/v/Vendicated/Navinecord?style=for-the-badge&logo=github&logoColor=d3869b&label=&color=1d2021&labelColor=282828)
...
-   Easy to install
-   [100+ built in plugins](https://Navinecord.dev/plugins)
-   Fairly lightweight despite the many inbuilt plugins
-   Excellent Browser Support: Run Navinecord in your Browser via extension or UserScript
...
Visit https://Navinecord.dev/download
...
|     **Thanks a lot to all Navinecord [sponsors](https://github.com/sponsors/Vendicated)!!**     |
| :------------------------------------------------------------------------------------------: |
...
<a href="https://star-history.com/#Vendicated/Navinecord&Timeline">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Vendicated/Navinecord&type=Timeline&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Vendicated/Navinecord&type=Timeline" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Vendicated/Navinecord&type=Timeline" />
  </picture>
</a>
...
<details>
<summary>Using Navinecord violates Discord's terms of service</summary>

Client modifications are against Discord’s Terms of Service.

However, Discord is pretty indifferent about them and there are no known cases of users getting banned for using client mods! So you should generally be fine as long as you don’t use any plugins that implement abusive behaviour. But no worries, all inbuilt plugins are safe to use!

Regardless, if your account is very important to you and it getting disabled would be a disaster for you, you should probably not use any client mods (not exclusive to Navinecord), just to be safe

Additionally, make sure not to post screenshots with Navinecord in a server where you might get banned for it
