...
const sourceMapFooter = s => watch ? "" : `//# sourceMappingURL=Navinecord://${s}.js.map`;
...
const buildConfigs = ([
    // Discord Desktop main & renderer & preload
    {
        ...
        footer: { js: "//# sourceURL=file:///NavinecordPatcher\n" + sourceMapFooter("patcher") },
        sourcemap,
        plugins: [
    ...
    {
        ...commonOpts,
        entryPoints: ["src/Navinecord.ts"],
        outfile: "dist/renderer.js",
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///NavinecordRenderer\n" + sourceMapFooter("renderer") },
        globalName: "Navinecord",
        sourcemap,
        plugins: [
    ...
    },
    {
        ...
        footer: { js: "//# sourceURL=file:///NavinecordPreload\n" + sourceMapFooter("preload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "true",
    ...
    // Navinecord Desktop main & renderer & preload
    {
        ...nodeCommonOpts,
        entryPoints: ["src/main/index.ts"],
        outfile: "dist/NavinecordDesktopMain.js",
        footer: { js: "//# sourceURL=file:///NavinecordDesktopMain\n" + sourceMapFooter("NavinecordDesktopMain") },
        sourcemap,
        plugins: [
            ...nodeCommonOpts.plugins,
            globNativesPlugin
    ...
    },
    {
        ...commonOpts,
        entryPoints: ["src/Navinecord.ts"],
        outfile: "dist/NavinecordDesktopRenderer.js",
        format: "iife",
        target: ["esnext"],
        footer: { js: "//# sourceURL=file:///NavinecordDesktopRenderer\n" + sourceMapFooter("NavinecordDesktopRenderer") },
        globalName: "Navinecord",
        sourcemap,
        plugins: [
            globPlugins("vesktop"),
    ...
    },
    {
        ...nodeCommonOpts,
        entryPoints: ["src/preload.ts"],
        outfile: "dist/NavinecordDesktopPreload.js",
        footer: { js: "//# sourceURL=file:///NavinecordPreload\n" + sourceMapFooter("NavinecordDesktopPreload") },
        sourcemap,
        define: {
            ...defines,
            IS_DISCORD_DESKTOP: "false",
